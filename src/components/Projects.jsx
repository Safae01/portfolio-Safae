...
export function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description:
        "Plateforme collaborative avec drag & drop intuitif, notifications push et système de permissions granulaire.",
      image: "/placeholder.svg?height=300&width=500",
      technologies: ["Vue.js", "Vuex", "Firebase", "Sass", "Socket.io"],
    ...
    },
    {
      ...
      description: "Site portfolio avec animations 3D, galerie immersive et optimisations de performance avancées.",
      image: "/placeholder.svg?height=300&width=500",
      technologies: ["React", "Three.js", "Framer Motion", "Styled Components"],
      liveUrl: "https://example.com",
      githubUrl: "https://github.com",
      featured: false,
    },
    {
      title: "Application Météo Intelligente",
      description:
        "App météo avec IA prédictive, géolocalisation avancée et interface adaptative selon les conditions.",
      image: "/placeholder.svg?height=300&width=500",
